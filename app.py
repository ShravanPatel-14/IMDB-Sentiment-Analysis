...
#     from flask import render_template  # add at top with other imports
...
#         logger.error("MODEL_DIR does not exist: %s. Save your model with model.save_pretrained(OUTPUT_DIR) first.", MODEL_DIR)
#         raise SystemExit(1)
