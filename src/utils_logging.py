...
#     # assume history is dict of lists with same length
...
#     """
#     history: dict like Keras History.history (keys: 'loss','accuracy','val_loss','val_accuracy')
#     Saves two PNGs: accuracy.png and loss.png in out_dir.
#     """
#     os.makedirs(out_dir, exist_ok=True)
...
#     return {
#         "accuracy_png": os.path.join(out_dir, "accuracy.png") if acc else None,
#         "loss_png": os.path.join(out_dir, "loss.png") if loss else None
#     }
